...
class [[eosio::contract("mining")]] token : public contract
{
public:
   ...
   static constexpr uint64_t GENESIS_BLOCK = 1597406400;              // UTC: 2020-08-14T12:00:00Z
    ...
    * Mine action.
    *
    * @details This action is mining token, and send to account `to`.
    *
   ...
   using mine_action = eosio::action_wrapper<"mine"_n, &token::mine>;
